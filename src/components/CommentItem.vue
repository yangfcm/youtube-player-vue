...
const commentItem = isTopComment
  ? (props.comment as CommentSnippet).snippet.topLevelComment.snippet
  : (props.comment as ReplySnippet).snippet
</script>
...
<template>
  <v-card variant="flat" class="mb-3">
    <div class="d-flex">
      <div class="mr-1 pa-1">
        <v-avatar :image="commentItem.authorProfileImageUrl" v-bind="props">
